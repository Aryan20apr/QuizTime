...
class UpdateQuestion extends StatefulWidget {
  UpdateQuestion({Key? key, required this.quiz, required this.question})
      : super(key: key);
  QuizData quiz;
...
class _UpdateQuestionState extends State<UpdateQuestion> {
  ...
  void initState() {
    ...
    descriptionController.text = widget.question.content!;
  ...
  Future<QuestionUpdateAlbum> updateQuestion(
      int questionid,
      String content,
      String option1,
      String option2,
    ...
    QuestionUpdateAlbum questionUpdateAlbum = await api.updateQuestion(
